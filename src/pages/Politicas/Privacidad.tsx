...
export const Privacidad = () => {
  return (
    <div className='privacidadContainer'>
        ...
        <p>El presente Política de Privacidad establece los términos en que RestoMaky usa y 
        ...
        <p>Nuestro sitio web podrá recoger información personal por ejemplo: Nombre información de contacto como su dirección de correo electrónica e información demográfica. 
        ...
        <p>RestoMaky está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para 
            asegurarnos que no exista ningún acceso no autorizado.</p><p><strong>Cookies</strong></p><p>Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso para 
        ...
        <p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia. Esta información es empleada únicamente para análisis estadístico y después 
        ...
        <p>Este sitio web pudiera contener en laces a otros sitios que pudieran ser de su interés. Una vez que usted de clic en estos enlaces y abandone nuestra página, ya no tenemos control 
        ...
        <p>En cualquier momento usted puede restringir la recopilación o el uso de la información personal que es proporcionada a nuestro sitio web. Cada vez que se le solicite rellenar 
            ...
            nuestro boletín o publicidad usted puede cancelarla en cualquier momento.</p><p>Esta compañía no venderá, cederá ni distribuirá la información personal que es recopilada sin su 
            consentimiento, salvo que sea requerido por un juez con un orden judicial.</p><p>RestoMaky Se reserva el derecho de cambiar los términos de la presente Política de Privacidad 
